    ...
    return (
        <>
            <div className={`fixed flex justify-center bg-purple-600 bg-opacity-20 left-3 ${ visible ? "hidden" : "block" }
                                top-[calc(100%-3rem)] z-10 backdrop-blur-md rounded-full w-10 h-10`}>
                <button aria-label="Süti elfogadás" onClick={ handleCookieClick } >
                    <CookieIcon />
                </button>            
            </div>

            <div className={`fixed w-[700px] md:w-[100vw] ${ visible ? "flex" : "hidden" } bg-slate-700 bg-opacity-25 py-2 px-3 top-[calc(100%-4.5rem)]
